...
changeSvgColorAfterAOS({
  selector: "object.icon_green",  // ID of the div that triggers the effect
  startColor: "black",
  endColor: "red",
  duration: 2000,  // Color change duration (ms)
  delay: 1000       // Extra delay after AOS animation finishes (ms)
});
