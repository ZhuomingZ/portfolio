...
*/
    ...
    console.log(document.querySelector(".realHand_right"));

    document.querySelector(".realHand_right").addEventListener("aos:in", () => {
      console.log("AOS animation triggered for image2");
    });
